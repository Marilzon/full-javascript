...
const countCrazyNumbers = crazyNumbers.reduce((accumulator, current) => {
	return current < 501 ? accumulator + 1 : accumulator
	// if (current < 501) {
...
const lower2000sMovies = tarantinoMovies
	.filter(({ release }) => release < 2000)
console.log(lower2000sMovies)
...
const gamesNames = cart.reduce((accumulator, { name }) => {
